...
Deckdle.dom.interactive.debugGameover = {
  ...
  btnDebugGameOverUnder1: document.getElementById('button-debug-gameover-under'),
  btnDebugGameOverUnder2: document.getElementById('button-debug-gameover-under-2'),
  btnDebugGameOverUnder3: document.getElementById('button-debug-gameover-under-3'),
  btnDebugGameOverUnder4: document.getElementById('button-debug-gameover-under-4'),
  btnDebugGameOverUnder5: document.getElementById('button-debug-gameover-under-5'),
  btnDebugGameOverUnder6: document.getElementById('button-debug-gameover-under-6'),
  btnDebugGameOverUnder7: document.getElementById('button-debug-gameover-under-7'),
  btnDebugGameOverUnder8: document.getElementById('button-debug-gameover-under-8'),
  btnDebugGameOverUnder9: document.getElementById('button-debug-gameover-under-9'),
